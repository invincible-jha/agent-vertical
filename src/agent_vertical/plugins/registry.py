"""Plugin registry for agent-vertical.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "agent_vertical.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("agent_vertical.plugins")
        """
