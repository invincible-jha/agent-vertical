"""Structural tests for agent-vertical benchmarks.
...
def test_bench_template_throughput_returns_expected_keys() -> None:
    """bench_template_instantiation_throughput returns a dict with required keys."""
    from bench_template_throughput import run_benchmark
...
def test_bench_template_throughput_ops_per_second_positive() -> None:
...
def test_bench_registry_latency_returns_expected_keys() -> None:
    """bench_registry_lookup_latency returns a dict with required keys."""
    from bench_registry_latency import run_benchmark
...
def test_bench_registry_latency_p99_present() -> None:
...
def test_bench_memory_usage_returns_expected_keys() -> None:
    """bench_registry_memory_usage returns a dict with required keys."""
