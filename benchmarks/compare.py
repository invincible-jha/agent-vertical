"""Comparison visualiser for agent-vertical benchmark results."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 80}")
    print("  agent-vertical Benchmark Results")
    print(f"{'=' * 80}")
    ...
    print("    python benchmarks/bench_template_throughput.py")
    print("    python benchmarks/bench_registry_latency.py")
